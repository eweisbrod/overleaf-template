...
% Possessive citation for biblatex-chicago: \citepos{key} renders as
% "Author's (Year)" -- e.g. \citepos{bernard1989post} -> "Bernard and
% Thomas's (1989)". The older definition that lived here called
% natbib internals (\NAT@test, \NAT@nmfmt, ...) which do not exist
% under biblatex-chicago and were the source of four "Undefined
% control sequence" errors at compile time.
