...
% ======================================================================
% A/B TEST: Two implementations of the multi-page Variable Definitions
% table. After you decide which you prefer, delete the other block plus
% this comment. Body-text \ref{vars} points to Option A (the longtable);
% Option B uses \label{vars-alt} so both can coexist temporarily.
% ======================================================================

% --- OPTION A: longtable (recommended) -------------------------------
% longtable integrates \caption natively (no \topcaption needed), scopes
% its formatting commands automatically, and is the more widely-seen
% choice in A/F papers.
\begingroup
\footnotesize
\setstretch{1.0}
\renewcommand{\arraystretch}{1.3}
\begin{longtable}{p{3.8cm}p{12cm}}
\caption{Variable Definitions (Option~A: longtable) \label{vars}} \\
\toprule
...
\multicolumn{2}{l}{\textbf{Additional Controls (Placeholder Examples)}}\\
\cmidrule{1-2}
...
% --- OPTION B: supertabular (in-place fix) ---------------------------
% Same content but using supertabular. The earlier supertabular block
% leaked \footnotesize / \arraystretch to surrounding content because
% those commands lived outside any environment. Here everything is
% wrapped in a \begingroup ... \endgroup so the formatting is scoped
% to the table, with single \midrule rules in the header rather than
% the double \toprule that looked too thick.
\begingroup
\footnotesize
\setstretch{1.0}
\renewcommand{\arraystretch}{1.3}
...
\tablehead{%
  \toprule
  \multicolumn{2}{l}{\textit{Table~\ref{vars-alt} continued from previous page}} \\
  \midrule
  \multicolumn{1}{l}{Variable} & \multicolumn{1}{l}{Definition} \\
  \midrule}
...
\topcaption{Variable Definitions (Option~B: supertabular) \label{vars-alt}}

\begin{supertabular}{p{3.8cm}p{12cm}}
...
$SIZE$ & Natural logarithm of market value of equity ($CSHOQ \times PRCCQ$). Winsorized at the 1st and 99th percentiles. In the regression, this variable is standardized to mean zero and unit standard deviation. \\
