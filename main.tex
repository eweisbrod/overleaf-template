...
% US Letter, width=0.65\textwidth lands both stacked panels plus the
...
\centering
\subfloat[SameSign Frequency by Size Quintile Over Time]{%
  \includegraphics[width=0.65\textwidth]{figures/size_year.pdf}}\\[1ex]
\subfloat[Year-by-Year ERC with Confidence Bands]{%
  \includegraphics[width=0.65\textwidth]{figures/erc_year.pdf}}
\par\medskip
\footnotesize
\begin{minipage}{\textwidth}
\begin{singlespace}
