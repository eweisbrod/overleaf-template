...
\label{fig:yearly}%
\centering
\subfloat[SameSign Frequency by Size Quintile Over Time]{\includegraphics[width=0.48\textwidth]{figures/size_year.pdf}}\hfill
\subfloat[Year-by-Year ERC with Confidence Bands]{\includegraphics[width=0.48\textwidth]{figures/erc_year.pdf}}%
\footnotesize
