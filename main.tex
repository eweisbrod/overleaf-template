...
$SUE$ & Unexpected Earnings. Calculated as $(IBQ_{q} - IBQ_{q-4}) / MVE_{q-1}$, where $IBQ$ is Compustat quarterly income before extraordinary items and $MVE_{q-1}$ is prior-quarter market value of equity ($CSHOQ_{q-1} \times PRCCQ_{q-1}$). Winsorized at the 1st and 99th percentiles. \\
